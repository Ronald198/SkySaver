              ...
              child: Column(
                ...
                children: [
                  FadeInUp(
                    ...
                    child: Text(
                      StaticVariables.userLoggedIn == null ? "Welcome, Guest" : "Welcome, ${StaticVariables.userLoggedIn!.user_name.split(' ')[0]}",
                      style: const TextStyle(color: Colors.black, fontSize: 35, fontWeight: FontWeight.w500),
                    )
                  ),
                  // FadeInUp(
